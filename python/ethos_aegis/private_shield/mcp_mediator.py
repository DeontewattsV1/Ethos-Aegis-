...
class MCPMediator:
    ...
    def invoke(
        ...
        *,
        ...
        # Evaluate first so the handler cannot execute before authorization. We
        # append the receipt after execution so its output hash corresponds to
        # the actual returned value while raw arguments/output remain outside the
        # evidence chain.
